...
public class PrObjective : MonoBehaviour {
    ...
    public void ActivateCompass()
    {
        ...
        foreach (GameObject p in play)
        {
            ...
            {
                p.GetComponent<PrTopDownCharInventory>().ActivateCompass(reachTarget);
            }
            ...
            else if (ObjectiveType == objectives.Destroy && detroyableTargets.Length == 1)
            {
                ...
                {
                    if (a != null)
                        p.GetComponent<PrTopDownCharInventory>().ActivateCompass(a.gameObject);
                }
    ...
    public void ActivateObjective()
    {
        ...
        if (ObjectiveType == objectives.Kill)
        {
            ...
            if (enemies.Length > 0)
            {
                ...
                {
                    if (enemy.dead == false || enemy == null)
                    {
                        Debug.Log(enemy);
